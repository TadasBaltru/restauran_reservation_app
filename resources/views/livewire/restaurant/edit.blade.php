        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
            <form wire:submit="save" class="p-6 lg:p-8">
                ...
                <div class="flex justify-between items-center mb-8">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Edit Restaurant</h1>
                        <p class="text-gray-600 dark:text-gray-400 mt-2">Update restaurant information and table configuration</p>
                    </div>
                    <button type="button" 
                            wire:click="cancel"
                ...
                <div class="mb-8">
                    ...
                    <input type="text" 
                           id="name" 
                           wire:model="name"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition duration-150 ease-in-out @error('name') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror"
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 border border-gray-200 dark:border-gray-600">
                                <div class="flex justify-between items-start mb-4">
                                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">
                                        Table {{ $index + 1 }}
                                        @if(!empty($table['id']))
                                            <span class="text-sm text-gray-500">(ID: {{ $table['id'] }})</span>
                                        @endif
                                    </h3>
                                    @if(count($tables) > 1)
                                        <button type="button" 
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" 
                                               ...
                                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 @error('tables.'.$index.'.name') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror"
                                    ...
                                    <div>
                                        ...
                                        <input type="number" 
                                               ...
                                               min="1"
                                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 @error('tables.'.$index.'.min_people_count') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" 
                                               ...
                                               min="1"
                                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 @error('tables.'.$index.'.max_people_count') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror">
